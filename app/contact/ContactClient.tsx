            ...
            <div className="container relative z-10 mx-auto px-4 md:px-6 pt-32 pb-24">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <h1 className="text-4xl sm:text-5xl md:text-7xl font-black mb-8 leading-[0.9]">
                            Let&apos;s Build <br />
                            <span className="text-gradient inline-block w-[14ch] sm:w-[15ch] text-left align-top h-[1.1em] whitespace-nowrap">
                                <ScrambledWord word={words[index]} />
                            </span>
                        </h1>
                        <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-lg">
                            Ready to turn your idea into reality? We are ready to help you build your next project.
                        ...
                        <div className="space-y-6">
                            ...
                            <ContactItem
                                ...
                                value="+91 98994 05614"
                                link="https://wa.me/919899405614"
                            />
                            <ContactItem
